...
1. `consumers-adopt` · done (developer)
2. `devkit-make-targets-are-quiet` · done (developer)
3. `gate-log-and-verdict` · done (developer)
4. `import-cache-runner` · done (developer)
5. `sandbox-home-and-project-file` · done (developer)
<!-- /pm:execution -->
