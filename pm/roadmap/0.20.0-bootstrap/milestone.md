...
1. `generic-runners` · done · 2/3 stories
2. `generic-scans` · done · 2/3 stories

**phase 2**

3. `ci-set` · done · 1/2 stories
4. `makefile-include` · done · 1/2 stories — after generic-runners, generic-scans

**phase 3**

5. `init-verb` · done · 2/2 stories — after makefile-include, ci-set
<!-- /pm:execution -->
