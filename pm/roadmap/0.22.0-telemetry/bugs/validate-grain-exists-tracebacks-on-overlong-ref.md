---
id: 0.22.0/bugs/validate-grain-exists-tracebacks-on-overlong-ref
milestone: "0.22.0"
...
while building `0.22.0/review-record-shape/S2`, whose own `_feature_exists` is guarded; the twin in
