# Feature Review — 0.22.0/usage-capture

**Commit range:** `236af3f..HEAD` (`dffa207`, `f44c0df`, and the
`pm(0.22.0/usage-capture)` closes), plus the uncommitted working tree at review time.
...
```text
$ cd /Users/cdowin/workspace/godot-devkit-0.22.0
...
| U4 | MINOR | deferred: 0.22.0/ledger-report |
```
