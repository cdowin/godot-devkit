# Feature Review — 0.23.0/review-record-shape

**Commit range:** `236af3f..HEAD` (`2250e76`, `d923103`, and the two
`pm(0.23.0/review-record-shape)` closes).
...
`pm/roadmap/0.23.0-telemetry/features/review-record-shape/stories/the-verdict-block.md`
...
| R4 | MINOR | deferred: 0.23.0/review-record-shape |
