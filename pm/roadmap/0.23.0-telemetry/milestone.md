...
1. `ledger` · done · 2/2 stories
2. `review-record-shape` · done · 2/2 stories

**phase 2**

3. `usage-capture` · done · 2/2 stories — after ledger

**phase 3**

4. `ledger-report` · done · 3/3 stories — after ledger, usage-capture, review-record-shape
<!-- /pm:execution -->
