...
1. `consumer-reads-leave-the-unit-suite` · done · 1/1 stories
2. `matrix-runs-bash-once` · done · 2/2 stories

**phase 2**

3. `smoke-proves-the-runners-the-release-ships` · done · 1/1 stories

**phase 3**

4. `the-lifecycle-says-what-it-means` · done · 0/0 stories
<!-- /pm:execution -->
